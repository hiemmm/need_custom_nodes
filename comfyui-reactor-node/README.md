...
### The Fast and Simple Face Swap Extension Node for ComfyUI, based on [blocked ReActor](https://web.archive.org/web/20241230084620/https://github.com/Gourieff/comfyui-reactor-node) (RIP Bro)
...
1. Go to `ComfyUI\custom_nodes`, open Console and run `git clone https://codeberg.org/Gourieff/comfyui-reactor-node`
2. Go to `ComfyUI\custom_nodes\comfyui-reactor-node` and run `install.bat`
...
## Models
 ...
 - hyperswap_256: https://huggingface.co/datasets/Gourieff/ReActor/tree/main/models (hyperswap_1a_256.onnx, hyperswap_1b_256.onnx, hyperswap_1a_256.onnx) put them into `ComfyUI\models\hyperswap`
